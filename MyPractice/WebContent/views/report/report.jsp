      ...
      <div id="content">
         ...
         <div id="content1">
            ...
            <div id="content1-1">
               <center>
                  <br>
                  <h1 id="title-2">신고접수</h1>
               </center>
            </div>
            <div id="content1-2">
               <div id="content1-2-1" >

                  <a href="/views/report/report.jsp"><button class="btn btn-danger" name="mybtn" >신고접수</button></a>
               </div>

				 <div id="content1-2-2" >

                  <a href="/reportList"><button class="btn" name="mybtn" >신고접수확인</button></a>
               </div>
            </div>
         </div>
         <div id="content2">
			...
			<table class="table table-bordered" id="table" align = "center">
				<tr>					
					...
					<th style="width:200px">작성자</th><td><input type="text" class="form-control" id="writer" name="writer" value="${member.userId }"></td>
					<th style="width:200px">신고<br>대상자</th><td><input type="text" class="form-control" id="report" name="report" ></td>
					<th style="width:200px">신고종류</th><td>
				...
				<tr>
					<td colspan="8">
						<textarea rows="20" class="form-control"  id="contentarea" name="contentarea"></textarea>
					</td>
				</tr>
				<tr>
