         ...
         <div id="content1">
            ...
            <div id="content1-2">
                <div id="content1-2-1" >
                  ...
                  <a href="/views/report/report.jsp"><button class="btn1" name="mybtn" style="background : white ; color : #515151;" >신고접수</button></a>
               </div>

             <div id="content1-2-2" >

                  <a href="/reportList"><button class="btn2" name="mybtn" style=" background: #c81a00;color:white;">신고접수확인</button></a>
               </div>
