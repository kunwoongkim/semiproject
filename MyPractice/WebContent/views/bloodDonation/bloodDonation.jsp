<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import= "java.util.ArrayList, bloodDonation.model.vo.BloodDonation, bloodDonation.model.vo.PageData"%>
            ...
            <div id="content1">
                ...
                <div id="content1-2">
                    ...
                    <div id="content1-2-3">
                        ...
                        <a href="/bloodDonation"><button class="btn btn-danger" name="mybtn">헌혈증 확인</button></a>
                    ...
                    <div id="content2-2-2">
                        ...
                        <center>
                            <table border="1">
                                ...
                                <c:forEach items="${pageData.pageList}" var="bd" varStatus="i">
                                    <tr>
                                        <!-- <td><input type="checkbox"></td> -->
                                        <td>
                                            <c:out value="${bd.userId}" />
                                        </td>
                                        <td>
                                            <c:out value="${bd.userName }" />
                                        </td>
                                        <td>
                                            <c:out value="${bd.bloodType }" />
                                        </td>
                                        <td>
                                            <c:out value="${bd.donorDate}" />
                                        </td>
                                        <td>
                                            <c:out value="${bd.userBirth}" />
                                        </td>
                                        <td>
                                            <c:out value="${bd.gender}" />
                                        </td>
                                        <td>
                                            <c:out value="${bd.cardNumber}" />
                                        </td>
                                        <td>
                                            <c:out value="${bd.donorType}" />
                                        </td>
