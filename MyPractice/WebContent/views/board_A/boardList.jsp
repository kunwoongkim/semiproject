      ...
      <div id="content">
				...
				<c:forEach items="${pageList}" var="board">
					<tr>
						...
						<td style="width: 40%" id=title1><a
							href="boardASelect?boardNumber=${board.boardNumber}&boardType=${boardType}"> <span
		...
		<div>
			...
			<c:if test="${sessionScope.member != null }">
				<a id ="writebutton1" style = "color : white;" href="/views/board_A/boardWrite.jsp?boardType=${boardType }"
					class="btn btn-danger pull-right" role="button">글쓰기</a>
			</c:if>

			<c:if test="${sessionScope.member == null }">
				<a id ="writebutton2" style = "color : white;" href="#" data-toggle="modal" data-target="#myModal"
					class="btn btn-danger btn pull-right" role="button">글쓰기</a>
			</c:if>
