...
<form action = "/boardUpdateCommit" method="post" name ="writeform" enctype = "multipart/form-data"">
<div class ="input-group" id = title_input>
	<span class = "input-group-addon" id = "basic-addon4" >제목</span>
	<input id = "title1" name = "subject" type = "text" class = "form-control input" aria-describedby = "basic-addon4" placeholder = "제목을 입력해주세요." value ="${board.title }">
</div>
<br>
		<textarea class="form-control" id="CKEditor" name="content">${board.boardContent }</textarea>
		<script type ="text/javascript">
				CKEDITOR.replace('CKEditor' ,
					{height : 500 ,
					 filesbrowserImageUploadUrl : '/uploadPicture'
						});
			</script>
			<br>
			<br>
		<input type="hidden" name="boardType" value="${param.boardType }">	
		<input type="hidden" name="boardNumber" id="boardNumber" value="${board.boardNumber }">
		<div class="write_info2">
            ...
            <div class="imgbtn">
            <input type = "file" name = "upfile" onchange = "fn_loadImg(this)" data-width="300" data-height="300"></div>
         </div>
		...
		<input style = "margin-top : 5px; margin-left : 8px;" id = submit class = "btn btn-danger btn-lg pull-right" type ="submit" value ="수정">
</form>
</div>		
</div>
...
$(document).ready(function(){
	...
	function reset_click(){
		...
		if(check)location.href='/boardASelect?boardNumber='+$("#boardNumber").val();
	}
