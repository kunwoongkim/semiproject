         ...
         <div id="content1">
            ...
            <div id="content1-2">
                <div id="content1-2-1">
                         ...
                         <a href="#"><button class="btn" name="mybtn" ></button></a>
                    </div>
                    <div id="content1-2-2">
          ...
          <div id="content2-1">
             &nbsp; <br>
               ...
               <h6 style="color: gray">
                  ...
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="/images/login_icon.png" width="30px" height="30px">공지사항>공지사항 검색

               </h6>

               <h1 style="font-weight: bold; color: dimgrey">&nbsp;&nbsp;&nbsp;공지사항 검색</h1><hr>

     </div>
            <h3>"${search }" 로 검색한 결과입니다.</h3>
            <div id="notice">
               <table style="margin:0 auto; width:90%;">
                  ...
                  <tbody>
                     <c:forEach items="${searchPageData}" var="notice">
                        <tr>
                  ...
                  <tfoot>
                     <tr>
                        <td colspan=5 align=center>${searchPageNavi }</td>
                     </tr>
