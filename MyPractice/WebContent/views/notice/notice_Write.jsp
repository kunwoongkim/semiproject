          ...
          <div id="content2-1">
             &nbsp; <br>
               ...
               <h6 style="color: gray">
                  ...
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="/images/login_icon.png" width="30px" height="30px">공지사항>공지사항 작성

               </h6>

               <h1 style="font-weight: bold; color: dimgrey">&nbsp;&nbsp;&nbsp;공지사항 작성</h1><hr>

     </div>
     <center>
         <form action="/noticeWrite.do" method = "post" enctype = "multipart/form-data" >
            <div class="boardAB_write" >
               <div class="write_head" style="margin: 0 auto;">
                  제목 : <input type="text" id="titleText" name="title" placeholder="제목을 입력해 주세요">
               </div>
               ...
               <div class="write_foot">
                  ...
                  <div class="btn_right">
                     <input class="btn btn-danger" type="submit" value="작성완료">
                     <button class="btn btn-danger" id="btn_foot" type="button" onclick="location.href='/noticeList.do'">취소</button>
                  </div>
               </div>
            </div>
            </form>
