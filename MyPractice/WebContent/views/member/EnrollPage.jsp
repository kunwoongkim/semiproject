...
<body>
						...
						<form action="enroll" method="post">
							<table style="width: 800px">
								...
								<tr>
									...
									<td><input type="password" name="userPwdre" id="userPwdre"></td>
								</tr>
							...
							<br>
							<center>
								<input type="submit" value="회원가입" onclick="send()" />&nbsp;&nbsp;&nbsp;&nbsp;<input
									type="reset" value="취소">
	...
	<script>
	 ...
	 function send() {
			...
			var userPwdre = $("#userPwdre").val().trim();
			

			if (!userPw || userPw.length < 1) {
				alert("비밀번호를 입력해주세요.");
				return false;
			}else if(!(userPw == userPwdre)){
