...
<body>
	...
	<div id="content">
		...
		<div id = "content1-2-1">
			...
			<a href="/views/member/Repwd.jsp"><button class="btn" name="mybtn" id="pwdbtn">비밀번호 변경</button></a>
			</div>
				<div id = "content1-2-3">
		...
		<div id = "content2-1">&nbsp; <br>
               <h6 style="color: gray">
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img id="img_icon1"
                     ...
                     width="30px ">마이페이지 > 비밀번호 변경
               </h6>

               <h1 style="font-weight: bold; color: dimgrey">&nbsp;&nbsp;&nbsp;비밀번호 변경</h1>
               <hr>
			</div>
		<div id ="content2-2">
