...
<body>
   ...
   <div id="content">
      ...
      <div id = "content1-1"><center><br><h1 style="color: dimgrey; font-weight: bold;">회원 서비스</h1></center></div>
      <div id= "content1-2">
      <div id="content1-2-2">
                  <a href="#"><button class="btn" name="mybtn">비밀번호 찾기</button></a>
               </div>
         </div>
      </div>
      <div id = "content2">
         ...
         &nbsp; <br>
               <h6 style="color: gray">
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img id="img_icon1"
                     ...
                     width="30px ">회원서비스 > 비밀번호 찾기
               </h6>

               <h1 style="font-weight: bold; color: dimgrey">&nbsp;&nbsp;&nbsp;비밀번호 찾기</h1>
               <hr>
    ...
    <div class="input-group-append" >
      <input type="hidden" value="확인" id="idbtn">
    </div>
  </div>    
 </center>
