      ...
      <div id="content">
         ...
         <div id="content1">
            ...
            <div id="content1-2">
               ...
               <div id="content1-2-2">
               <a href="/views/member/googleEnroll.jsp"><button class="btn" name="mybtn">추가 정보 입력</button></a>
                     ...
                     <input type="hidden" value="${param.name }" name = "name">
                           ...
                           <tr>
                              ...
                              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="userNickName"
                                 id="userNickName"> &nbsp; <input type="button" class="enrollBtn"
                                 value="중복검사" onclick="nickNameDuplicate()"><br><br></td>
                           </tr>
