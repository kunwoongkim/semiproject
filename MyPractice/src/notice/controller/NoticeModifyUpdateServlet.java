...
/**
 * Servlet implementation class NoticeModifyUpdateServlet
 */
@WebServlet("/noticeModifyUpdate.do")
public class NoticeModifyUpdateServlet extends HttpServlet {
   private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public NoticeModifyUpdateServlet() {
        super();
   ...
   protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      int result = new NoticeService().updateNotice(nOne);
